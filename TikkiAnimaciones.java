...
/**
 * Dibujo del personaje Tikki con animaciones.
 * 
 * @author Brandon Alexis Prado Castro (19051178)
 * @version 4.0. 01.10.2021
 */
public class TikkiAnimaciones extends Application {
    @Override
    public void start(Stage primaryStage) {
        ...
        for (int i = 0; i < 30; i++) {
           Circle circle = new Circle(150, Color.web("PURPLE", 0.10));
           circle.setStrokeType(StrokeType.OUTSIDE);
           circle.setStroke(Color.web("BLACK", 0.25));
        ...
        Timeline animacionMultip = new Timeline();
        circles.getChildren().forEach(circle -> {
            ...
            //Circulos aleatorios
            animacionMultip.getKeyFrames().addAll(
        ...
        //Ejecucion de la animacion multiple
        animacionMultip.play();
