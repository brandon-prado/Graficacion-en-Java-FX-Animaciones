...
/**
 * Dibujo del personaje Duusu con animaciones.
 * 
 * @author Brandon Alexis Prado Castro (19051178)
 * @version 4.0. 04.10.2021
 */

public class DuusuAnimaciones extends Application {
    @Override
    public void start(Stage primaryStage) {
        ...
        for (int i = 0; i < 30; i++) {
           Circle circle = new Circle(150, Color.web("GREEN", 0.10));
